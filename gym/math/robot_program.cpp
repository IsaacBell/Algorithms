...
void solution() {
  ...
  ll x = 0, y = 0, o = 0;
  bool wasLastMoveOnXAxis = false;
  bool wasLastMoveOnYAxis = false;
  
  while (x < a || y < b) {
    // deb2(wasLastMoveOnXAxis, wasLastMoveOnYAxis);
    if (wasLastMoveOnYAxis && x == a) o++, wasLastMoveOnYAxis = false;
    if (wasLastMoveOnXAxis && y == b) o++, wasLastMoveOnXAxis = false;

    if (x < a && !wasLastMoveOnXAxis)      o++, x++, wasLastMoveOnXAxis = true, wasLastMoveOnYAxis = false;
    else if (y < b && !wasLastMoveOnYAxis) o++, y++, wasLastMoveOnYAxis = true, wasLastMoveOnXAxis = false;
